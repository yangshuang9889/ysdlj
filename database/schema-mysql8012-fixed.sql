...
CREATE TABLE IF NOT EXISTS `links` (
  ...
  CONSTRAINT `fk_links_domain_id` FOREIGN KEY (`domain_id`) REFERENCES `domains` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_links_group_id` FOREIGN KEY (`group_id`) REFERENCES `link_groups` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_links_ad_id` FOREIGN KEY (`ad_id`) REFERENCES `ads` (`id`) ON DELETE SET NULL
